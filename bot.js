...
client.user.setGame(`heello`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on('message', message => {
  ...
  const channel = client.channels.get('480640981235007488');
...
'*** انا لست الحوت الازرق كما يدعون ***',
   ...
   '*** انتظر الجزء الثاني عندما يوصل البوت 100 سيرفر , ساعدنا في نشر البوت     ***'
]
 client.on('message', message => {
 if (message.content.startsWith('!مريم')) {
  ...
  client.on('message',async message => {
    if(message.content.startsWith(prefix + "restart")) {
        if(message.author.id !== "430038396585377793") return message.reply('You aren\'t the bot owner.');
...
if (message.content === '!invite') {
      message.author.send('  https://discordapp.com/oauth2/authorize?client_id=457187112564031510&permissions=522304&scope=bot  |  تفضل ربط البوت     ').catch(e => console.log(e.stack));
